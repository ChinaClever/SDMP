...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('bus', '0004_boxeventmodel_boxindexmodel_delete_bareventmodel_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('box', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='bus.boxindexmodel')),
            ],
            options={
