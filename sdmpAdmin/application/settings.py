...
INSTALLED_APPS = [
    ...
    "captcha",
    'application.login',
    'application.sys_mange.level',
    'application.sys_mange.position',
    'application.sys_mange.dept',
    'application.sys_mange.role',
    'application.sys_mange.role_menu',
    'application.demo.data.city',
    'application.demo.content_manage.item',
    'application.demo.content_manage.item_cate',
    'application.demo.data.link',
    'application.demo.operation_center.ad_sort',
